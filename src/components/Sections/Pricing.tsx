...
const plans = [
    ...
    {
        name: "Profissional",
        description: "Para empresas em expansão que buscam melhorar a eficiência dos sistemas existentes.",
        price: "R$ 799,00",
        features: [
            "All Free features",
...
const PricingCard = ({ name, description, price, features }) => (
    <div className="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200 bg-white">
        ...
        <div className="pt-6 pb-8 px-6">
            <h3 className="text-sm font-bold text-slate-900 uppercase" style={{fontSize: "1.2rem", fontWeight: "800"}}>Serviços Inclusos</h3>
            <ul className="mt-4 space-y-3">
                {features.map((feature, index) => (
                    <li key={index} className="flex space-x-3">
                        <svg className="h-5 w-5 text-green-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
...
export const Pricing = () => (
    <section className="py-16 bg-gray-100" id="pricing">
        <div className="container mx-auto text-center">
            <div>
                <h3 className="text-2xl font-semibold text-gray-900">Encontre o Plano Perfeito Para Suas Necessidades</h3>
