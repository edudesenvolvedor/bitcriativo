...
export const About = () => {
    ...
    return (
        <Sections ref={sectionRef} label={"Sobre nós"} labelAlign={"bottomRight"} className={"grid md:grid-cols-2 gap-8"}>
            <motion.div
            ...
            >
                ...
                <div className="mt-6 flex">
                    <Link
                        className={"flex items-center justify-center font-medium rounded-lg transition-all duration-300 cursor-pointer bg-gray-900 text-white hover:bg-gray-700 py-3 px-6"}
                        href={"/#contato"}
                    >
                        Fale Conosco
                    </Link>
