            ...
            <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                    <Dialog.Panel className="bg-white rounded-lg p-6 max-w-md w-full shadow-lg">
                        <Dialog.Title className="text-xl font-bold text-gray-900">Inscrição na Vaga</Dialog.Title>
                        <Dialog.Description className="text-gray-600 mb-4">Preencha os dados para se candidatar</Dialog.Description>

                        <form onSubmit={handleSubmit} className="space-y-4">
                            <Input name="nome" placeholder="Nome completo" value={formData.nome} onChange={handleChange} error={!!errors.nome} />
                            ...
                            <Input name="telefone" placeholder="Telefone" value={formData.telefone} onChange={handleChange} error={!!errors.telefone} />
                        ...
                        <button onClick={() => setIsOpen(false)} className="mt-4 text-gray-600 underline text-sm">
                            Fechar
                        </button>
                    </Dialog.Panel>
                </div>
